                ...
                <div class="col-lg-12">
                    <div class="text-center">
                        <a href="{{ url('index') }}" class="mb-5 d-block auth-logo">
                            <img src="{{ URL::asset('/assets/img/difest-logo.png') }}" alt="" height="100" class="logo logo-dark">
                            <img src="{{ URL::asset('/assets/img/difest-logo.png') }}" alt="" height="100" class="logo logo-light">
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                <h5 class="text-primary">DIFEST</h5>
